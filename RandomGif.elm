...
-- with the new gif url in the case of success.
-- Finally, we don't want to introduce new Cmds with this update, so we
-- explicitly add a Cmd.none command to our app's state.
...
-- We'll just show the model's gifUrl using css
